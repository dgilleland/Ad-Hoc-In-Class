<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddEditProduct.aspx.cs" Inherits="Admin_AddEditProduct" %>
                ...
                <div class="col-sm-6">
                    <div class="form-inline">
                        <div class="form-group">
                            ...
                            <asp:LinkButton ID="ShowProductDetails" runat="server" CssClass="btn btn-primary" OnClick="ShowProductDetails_Click" CausesValidation="false">Show Product Details</asp:LinkButton>
                        </div>
                    </div>
                </div>
